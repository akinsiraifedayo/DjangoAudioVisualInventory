    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ftype', models.CharField(choices=[('savings', 'savings'), ('investment', 'investment'), ('loan', 'loan'), ('target', 'target')], default='savings', max_length=255)),
            ],
        ),
        migrations.CreateModel(
            name='User',
            fields=[
                ...
                ('Feeds', models.ManyToManyField(blank=True, to='users.feed')),
