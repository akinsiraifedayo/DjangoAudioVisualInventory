...
$(function () {
  ...
  var dt_transaction_table = $('.datatablesf-transaction');
  ...
  if (dt_transaction_table.length) {
    var dt_transaction = dt_transaction_table.DataTable({
      ...
      buttons: [
        ...
        {
          text: '<i class="ti ti-plus me-0 me-sm-1 ti-xs"></i><span class="d-none d-sm-inline-block">Add Warehouse</span>',
          className: 'add-new btn btn-primary' + (addWarehouseBtn ? '' : ' disabled'),
