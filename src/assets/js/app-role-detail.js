...
$(function () {
  ...
  if (dt_user_table.length) {
    var gottenUsers = JSON.stringify(getUsers);
    var dt_user = dt_user_table.DataTable({
        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
            ...
            return (
              ...
              '<a href="'+$id+'/unassign/" class="text-body delete-record"><i class="ti ti-trash ti-sm mx-2"></i></a>' +
      ...
      buttons: [
        ...
        {
          text: '<i class="ti ti-plus me-0 me-sm-1 ti-xs"></i><span class="d-none d-sm-inline-block">Assign Users</span>',
