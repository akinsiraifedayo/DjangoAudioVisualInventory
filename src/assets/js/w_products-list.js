  ...
  if (dt_transaction_table.length) {
    var dt_transaction = dt_transaction_table.DataTable({
      ...
      buttons: [
        ...
        {
          text: '<i class="ti ti-plus me-0 me-sm-1 ti-xs"></i><span class="d-none d-sm-inline-block">Add Warehouse Product</span>',
          className: 'add-new btn btn-primary' + (addWproductBtn ? '' : ' disabled'),
          action: function (e, dt, button, config) {
            window.location.href = '/w_products/add/';
          }
