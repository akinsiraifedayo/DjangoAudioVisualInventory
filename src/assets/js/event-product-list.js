      ...
      columnDefs: [
        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
            var $sku = full['sku'];
            // made edit here
            var $cart_qty = '<input type="number" class="form-control form-control-sm w-px-100 mt-2" value="1" min="1" max="1000">'
            return $cart_qty;
          }
        },
        {
      ...
      initComplete: function () {
        ...
        this.api()
          ...
          .every(function () {
            var column = this;
            var select = $(
              '<select id="ProductCategory" class="form-select text-capitalize"><option value="">{% translate "category" %}</option></select>'
            )
